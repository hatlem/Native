...
function no_initial(a: BuildArgs): Built {
  ...
  return {
    ...
    text: [
      greeting,
      ``,
      `Vi har en annonsør vi ønsker å sjekke priser og muligheter for, og titlene deres er aktuelle. Vi vil gjerne ha en oversikt over priser for native og advertorial på:`,
      ``,
      titleLines(a.titles, (n) => `…og ${n} til`),
      ``,
      `Formater vi er interessert i:`,
      `  • Native-artikkel / advertorial`,
      `  • Sponset innhold`,
      `  • Brand stories`,
      `  • Video native`,
